...
public class RoseQuartzAxe extends ItemTool {

    private static final Set<Block> EFFECTIVE_ON = Sets.newHashSet(Blocks.PLANKS, Blocks.BOOKSHELF, Blocks.LOG, Blocks.LOG2, Blocks.CHEST, Blocks.PUMPKIN, Blocks.LIT_PUMPKIN, Blocks.MELON_BLOCK, Blocks.LADDER, Blocks.WOODEN_BUTTON, Blocks.WOODEN_PRESSURE_PLATE);

       public RoseQuartzAxe() {
        super(ROSE_QUARTZ_AXE, EFFECTIVE_ON);
           setRegistryName("rose_quartz_axe");
           setTranslationKey(PinkMod.MOD_ID + ".rose_quartz_axe");
    ...
    public boolean getIsRepairable(ItemStack input, ItemStack repair)
    {
        ...
        return input.getItem() == ModItems.roseQuartzAxe && repair.getItem() == ModItems.roseQuartz;
    }
