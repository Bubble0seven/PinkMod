...
public class BlockPinkFarmland extends Block implements IGrowable {
    ...
    public BlockPinkFarmland() {
        super(Material.GROUND);
        this.setTickRandomly(true);
        setRegistryName(new ResourceLocation(PinkMod.MOD_ID, "pink_farmland"));
    ...
    public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side) {
        switch (side) {
            ...
            case EAST:
                ...
                return !iblockstate.isOpaqueCube() && block != ModBlocks.blockPinkFarmland && block != Blocks.GRASS_PATH;
            default:
