package jinkhya.pinkmod.entity;
...
public class VillagersFarmland extends EntityAIMoveToBlock
{
    ...
    public VillagersFarmland(EntityVillager villagerIn, double speedIn)
    {
    ...
    protected boolean shouldMoveTo(World worldIn, BlockPos pos)
    {
        ...
        if (block == ModBlocks.blockPinkFarmland)
        {
            pos = pos.up();
